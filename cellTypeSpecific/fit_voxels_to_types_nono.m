function fitVoxelsToTypesNoVolume = fit_voxels_to_types_nono( Ref, D, M, colsToUseInAllen, colsToUseInTypes, typeIndicesPicked )
...
for vv = 1 : numVox
    ...
    %a column to fit
    voxelData = voxelData';
    fitVoxelsToTypesNoVolume( vv, : ) = lsqlin( MTakenGeneByType, double( voxelData ), diagNegTypes, refZeroTypes );
end
